...
genai.configure(api_key="AIzaSyCJOm2Hj8tC8KJ_dUc4KHhV3M4lPzHxJKc")

user_id = None
conn = mysql.connector.connect(
    host="localhost", user="root", password="##1Piece", database="akerman_elite"
)
cursor = conn.cursor()
...
def create_home_ui():
    ...
    for feature, color,*rest in features:
